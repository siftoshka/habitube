...
public class DiscoverNetflixFragment extends MvpAppCompatFragment implements DiscoverView {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (bundle != null) {
            shows = bundle.getParcelableArrayList("Discover-N0");
            if (shows == null) {
                shows = bundle.getParcelableArrayList("Discover-N1");
                if (shows == null) {
                    shows = bundle.getParcelableArrayList("Discover-N2");
                }
            }
        }
    }
