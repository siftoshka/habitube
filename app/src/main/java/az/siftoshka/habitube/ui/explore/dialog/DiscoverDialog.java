...
import az.siftoshka.habitube.presentation.explore.dialog.discover.DiscoverDialogPresenter;
import az.siftoshka.habitube.presentation.explore.dialog.discover.DiscoverDialogView;
...
public class DiscoverDialog extends MvpBottomSheetDialogFragment implements DiscoverDialogView {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (bundle != null) {
            if (bundle.getInt("DISCOVER") == 0) index = 0;
            else if (bundle.getInt("DISCOVER") == 1) index = 1;
        }
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        else view = inflater.inflate(R.layout.dialog_show_discover, container, false);
