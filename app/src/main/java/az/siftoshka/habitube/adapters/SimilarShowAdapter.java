...
public class SimilarShowAdapter extends RecyclerView.Adapter<SimilarShowAdapter.ShowHolder> {
    ...
    public SimilarShowAdapter(@NonNull ShowItemClickListener clickListener, @NonNull OnItemLongClickListener longClickListener) {
    ...
    public void onBindViewHolder(@NonNull ShowHolder holder, final int position) {
        ...
        ImageLoader.loadOffline(holder.itemView, shows.getMovieImage(), holder.posterImage);
