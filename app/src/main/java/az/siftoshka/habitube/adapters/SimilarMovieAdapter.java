...
public class SimilarMovieAdapter extends RecyclerView.Adapter<SimilarMovieAdapter.MovieHolder> {
    ...
    public SimilarMovieAdapter(@NonNull MovieItemClickListener clickListener, @NonNull OnItemLongClickListener longClickListener) {
    ...
    public void onBindViewHolder(@NonNull MovieHolder holder, final int position) {
        ...
        ImageLoader.loadOffline(holder.itemView, movie.getMovieImage(), holder.posterImage);
