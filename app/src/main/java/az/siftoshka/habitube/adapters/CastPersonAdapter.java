...
public class CastPersonAdapter extends RecyclerView.Adapter<CastPersonAdapter.CastHolder> {
    ...
    public CastPersonAdapter(@NonNull CastItemClickListener clickListener) {
    ...
    public void onBindViewHolder(@NonNull CastHolder holder, final int position) {
        ...
        holder.posterLayout.setOnClickListener(v -> clickListener.onPostClicked(post.getId()));
    }
